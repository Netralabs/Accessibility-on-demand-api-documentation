...
public class Step6CheckReport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (JsonElement el : reportProcess) {
            ...
            java.net.http.HttpResponse<String> resp = AOD.get(AOD.BASE_URL + "/report/" + jobId, apiKey);
            JsonObject body;
            try {
                ...
                AOD.logJobError(jobId, resp.statusCode(), "Could not read/parse report response", null);
                pending++;
                continue;
            }
