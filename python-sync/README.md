...
- **`can't open file '....py': [Errno 2] No such file or directory`** — you're running from the wrong folder. `cd python-sync` first, then run the command (type `ls` — you should see the step files).
